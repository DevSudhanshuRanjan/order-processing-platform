    ...
    >
      ...
      <div className="p-stack-md flex flex-col flex-grow">
        <div className="flex justify-between items-start mb-stack-sm gap-2">
          <h3 className="font-headline-lg text-headline-lg text-primary dark:text-white line-clamp-1">
            {product.name}
          </h3>
          <span className="font-headline-lg text-headline-lg text-on-surface-variant dark:text-gray-300 flex-shrink-0">
            ₹{product.price}
          </span>
        </div>
